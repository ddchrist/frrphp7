...
">Info:<br></span>
   ...
   <p style="color:rgb(151,187,205);">Mid: cla/cor</p>
   <p style="color:rgb(120,167,190);">Bot: clo/dup/dnr</p>
   </td>
   <td>
...
function MakeReport() { 
   ...
   $arrHeaders=array("DateOfCreation", "S/W_cla/cor_date", "S/W_clo/d??_Date");
   $m = new Mongo();
   ...
   if($DetectedRelease<>"") {
      ...
      $query = array('Version' => new MongoRegex("/$DetectedRelease/i"));
   }
   else {     
      $query = array('Version' => new MongoRegex("/B/"));  // which is any PCR or all - trick!
   }
?> 
<br>
<?php
...
?>
<form action="search_report_accumulated.php" method="post">
